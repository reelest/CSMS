...
/** @type {Array<import("@/shared/models/lib/model_type_info").StringType>} */
const INPUT_TYPES = ["email", "password", "tel", "url"];

/** @param {import("@/shared/models/lib/model_type_info").ModelPropInfo} meta*/
function collectInputProps(meta) {
  return Object.keys(meta).reduce((acc, _key) => {
    /** @type {keyof import("@/shared/models/lib/model_type_info").ModelPropInfo}*/
    let key = _key;
    let value = meta[key];
